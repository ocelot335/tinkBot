...
public class Keys {
    ...
    public static final ForeignKey<SubscribesRecord, ChatsRecord> SUBSCRIBES_CHATID_FKEY = Internal.createForeignKey(
        Subscribes.SUBSCRIBES,
        DSL.name("SUBSCRIBES_CHATID_FKEY"),
        new TableField[] {Subscribes.SUBSCRIBES.CHATID},
        Keys.CHATS_PKEY,
        new TableField[] {Chats.CHATS.TELEGRAMID},
        true
    );
    public static final ForeignKey<SubscribesRecord, LinksRecord> SUBSCRIBES_LINKID_FKEY = Internal.createForeignKey(
        Subscribes.SUBSCRIBES,
        DSL.name("SUBSCRIBES_LINKID_FKEY"),
        new TableField[] {Subscribes.SUBSCRIBES.LINKID},
        Keys.LINKS_PKEY,
