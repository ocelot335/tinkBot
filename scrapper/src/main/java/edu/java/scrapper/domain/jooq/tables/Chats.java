...
public class Chats extends TableImpl<ChatsRecord> {
    ...
    /**
     * The column <code>CHATS.TELEGRAMID</code>.
     */
    public final TableField<ChatsRecord, Long> TELEGRAMID = createField(DSL.name("TELEGRAMID"), SQLDataType.BIGINT.nullable(false), this, "");
