...
public class KafkaProducerConfiguration {
    @Bean
    public ProducerFactory<Long, LinkUpdate> producerFactory(ApplicationConfig.KafkaProducerConfig kafkaProducerProperties) {
        ...
        props.put(ProducerConfig.DELIVERY_TIMEOUT_MS_CONFIG, (int) kafkaProducerProperties.deliveryTimeout().toMillis());
